...
>
> *Ton premier chiffre — calcule (attention à l'ordre des opérations !) :*
> *jours dans une semaine × oreilles de Nabuzoko − pattes d'un lapin × 3*

**→ Chiffre 1 du cadenas**: 7 × 2 − 4 × 3 = 14 − 12 = **2**
*(Sans PEDMAS, gauche→droite: 7×2=14, 14−4=10, 10×3=30 → faux)*
...
Sur un carton séparé dans l'œuf de la cabane des lapins:

> *"Ton deuxième chiffre (attention à l'ordre des opérations !) :*
> *pattes d'un lapin × queues d'un lapin + mois dans une année ÷ pattes d'un lapin"*

→ 4 × 1 + 12 ÷ 4 = **4 + 3 = 7**
*(Sans PEDMAS G→D: 4×1=4, 4+12=16, 16÷4=4 → faux)*
...
## ÉTAPE 5 — Le Nid Indestructible `[CR01]`
...
> *"Ton troisième chiffre (attention à PEDMAS !) :*
> *pattes × oreilles − queues × (saisons − queues)"*

→ 4 × 2 − 1 × (4 − 1) = 8 − 3 = **5**
*(Sans PEDMAS: 4×2=8, 8−1=7, 7×(4−1)=21 → faux)*

Et annonce: *"La prochaine épreuve est dehors."*

---

## ÉTAPE 6 — La Course du Cycliste le Plus Lent `[P01]`
...
- **Chiffre 4 du cadenas**:
  > *"Ton quatrième chiffre (attention aux parenthèses !) :*
  > *saisons × saisons ÷ (saisons − oreilles)"*
  > → 4 × 4 ÷ (4 − 2) = 16 ÷ 2 = **8**
  > *(Sans parenthèses: 4×4÷4−2 = 16÷4−2 = 4−2 = 2 → faux)*
...
| # | Étape | Calcul |
|---|---|---|
| **Chiffre 1** | Étape 1 — miroir | 7×2 − 4×3 = **2** |
| **Chiffre 2** | Étape 3 — Pig Pen | 4×1 + 12÷4 = **7** |
| **Chiffre 3** | Étape 5 — nid | 4×2 − 1×(4−1) = **5** |
| **Chiffre 4** | Étape 6 — vélo | 4×4÷(4−2) = **8** |
| **→ Code** | | **2 - 7 - 5 - 8** |
...
- [ ] Vérifier que le code **2-7-5-8** ouvre bien le cadenas
